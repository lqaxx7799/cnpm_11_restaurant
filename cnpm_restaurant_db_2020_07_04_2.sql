...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 04, 2020 lúc 11:55 AM
...
CREATE TABLE `coupons` (
  ...
  `coupon_name` varchar(128) COLLATE utf8_vietnamese_ci NOT NULL,
...
CREATE TABLE `customers` (
  `id` int(11) NOT NULL,
  `customer_name` varchar(256) COLLATE utf8_vietnamese_ci NOT NULL,
  `created_time` datetime NOT NULL,
  `collected_point` int(11) NOT NULL,
  `email` varchar(256) COLLATE utf8_vietnamese_ci NOT NULL,
  `employee_id` int(11) NOT NULL,
  `customer_type` varchar(16) COLLATE utf8_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
INSERT INTO `receipts` (`id`, `arrived_time`, `paid_time`, `is_paid`, `table_id`, `account_id`, `total_discount_percentage`, `customer_id`) VALUES
(1, '2020-06-02 11:19:05', '2020-06-02 11:59:05', b'1', 1, 6, NULL, NULL),
(2, '2020-06-06 18:05:05', '2020-06-06 19:25:05', b'1', 2, 6, NULL, NULL);
...
CREATE TABLE `sales` (
  ...
  `created_time` datetime NOT NULL,
  `expired_time` datetime NOT NULL,
  `sale_name` varchar(256) COLLATE utf8_vietnamese_ci NOT NULL,
  `sale_type` varchar(16) COLLATE utf8_vietnamese_ci NOT NULL,
  `account_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `accounts` (`id`),
  ADD CONSTRAINT `customers_ibfk_2` FOREIGN KEY (`id`) REFERENCES `receipts` (`customer_id`);
...
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`);
...
ALTER TABLE `sale_details`
  ...
  ADD CONSTRAINT `sale_details_ibfk_2` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`id`);
